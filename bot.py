...
TOKEN = os.environ.get('BOT_TOKEN', "8675623246:AAG17fieaauWE469eMDKh1VSUtkHC95tfqY")
API_URL = os.environ.get('API_URL', "http://fi8.bot-hosting.net:20163/elos-gemina")
...
if __name__ == "__main__":
    print("🚀 bot çalışıyor...")
    print("📌 her kanal kendi adminini tanır")
    print("📌 log kanalları kanala özeldir")
